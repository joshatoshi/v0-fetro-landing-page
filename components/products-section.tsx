...
const products = [
  {
    ...
    description: "In the era of generated reality, authenticity requires proof. CAIM 1 attests the human origin of your media the second you press record, and safely stores it forever.",
    specs: [
      "Hardware attestation at capture",
      "Modular lens design & 4\" touch UI",
      "Proofs stored immutably",
    ],
